<template>
    <div class="dictionary-page">
                ...
                <div class="dictionary-main">
                    ...
                    <div class="search-section">
                        <div class="search-box-container">
                            <input v-model="searchKeyword" type="text" class="dictionary-input"
                                placeholder="输入文言文字词如(庖丁、鸿鹄)" @keyup.enter="performSearch" @input="handleInput"
                                aria-label="输入要查询的文言文字词" />
                            <button class="dictionary-search-btn" type="button" :disabled="!searchKeyword.trim()"
                                @click="performSearch">
                    ...
                    <div v-if="searchResult" class="result-section">
                        ...
                        <div class="meaning-section">
                            ...
                            <div class="meanings-list">
                                <div v-for="(meaning, index) in searchResult.meanings" :key="index"
                                    class="meaning-item">
                        ...
                        <div v-if="searchResult.examples && searchResult.examples.length > 0" class="examples-section">
                            ...
                            <div class="examples-list">
                                <div v-for="(example, index) in searchResult.examples" :key="index"
                                    class="example-item">
                                    {{ example }}
                                </div>
                            </div>
                    ...
                    <div v-else-if="hasSearched && !searchResult" class="no-result">
                        ...
                        <div class="suggestions">
                            ...
                            <span v-for="word in popularWords" :key="word" class="suggestion-word"
        ...
        <!-- 站内确认弹窗：清空查询历史（避免浏览器 confirm 弹窗） -->
        <div v-if="showClearHistoryConfirm" class="confirm-overlay" role="dialog" aria-modal="true"
            aria-label="清空查询历史确认" @click.self="cancelClearHistory">
            <div class="confirm-dialog">
                <h3 class="confirm-title">清空查询历史</h3>
                <p class="confirm-desc">确定要清空查询历史吗？此操作不可撤销。</p>
